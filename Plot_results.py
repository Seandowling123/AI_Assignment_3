...
plt.title('Win Ratios of Q-learning & Default Player with The Q-learning Agent As Player 1', fontsize=12, fontfamily='serif')
...
plt.gca().set_ylim(0, 1)
plt.legend(fontsize=11, loc='upper left', prop={'family': 'serif', 'size': 11})
plt.title('Win Ratios of Q-learning & Minimax with The Q-learning Agent As Player 1', fontsize=12, fontfamily='serif')
plt.xlabel('Number of Training Iterations For Q-Learning Player (e+5)', fontsize=11, fontname='Times New Roman')
plt.ylabel('Ratio', fontsize=11, fontname='Times New Roman')
...
plt.ylim(0, 1)
plt.legend(fontsize=11, loc='upper left', prop={'family': 'serif', 'size': 11})
plt.title('Win Ratios of Q-learning & Minimax with Minimax As Player 1', fontsize=12, fontfamily='serif')
plt.xlabel('Number of Training Iterations For Q-Learning Player (e+5)', fontsize=11, fontname='Times New Roman')
plt.ylabel('Ratio', fontsize=11, fontname='Times New Roman')
